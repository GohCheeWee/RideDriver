...
public class InfinityViewPagerAdapter extends FragmentStatePagerAdapter {

    private ArrayList<ViewPagerObject> viewPagerItemList;
    private Map<Integer, String> mFragmentTags;
    private FragmentManager mFragmentManager;

    public InfinityViewPagerAdapter(FragmentManager fm, ArrayList<ViewPagerObject> viewPagerItemList) {
        super(fm);
    ...
    public CharSequence getPageTitle(int position) {
        return viewPagerItemList.get(position).getTitle();
    }
